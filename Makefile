...
tests-privileged: GO_TAGS_FLAGS+=privileged_tests ## Run unit-tests for cilium that requires elevated previliges.
tests-privileged:
...
reload: ## Reload cilium and cilium-docker systemd service after installing built binaries.
